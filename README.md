...
| port_check.yml | host (localhost) <br> port (22) | `ansible-playbook -i hosts port_check.yml -e port=8080` <br> `ansible-playbook -i hosts port_check.yml -e host=8.8.8.8`
